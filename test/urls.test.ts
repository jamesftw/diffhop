...
describe('matchGitHubDiffUrl', () => {
  ...
  it('strips PR sub-tabs like /files and /commits', () => {
    expect(matchGitHubDiffUrl('https://github.com/o/r/pull/5/files')?.path).toBe(
      '/o/r/pull/5',
    )
    expect(matchGitHubDiffUrl('https://github.com/o/r/pull/5/commits')?.path).toBe(
      '/o/r/pull/5',
    )
  })

  it('strips query strings and hash fragments', () => {
    expect(matchGitHubDiffUrl('https://github.com/o/r/pull/5?w=1')?.path).toBe(
      '/o/r/pull/5',
    )
    expect(matchGitHubDiffUrl('https://github.com/o/r/pull/5#diff-abc')?.path).toBe(
      '/o/r/pull/5',
    )
  })
